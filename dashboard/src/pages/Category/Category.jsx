...
//               <div className="modal-header">
//                 <h5 className="modal-title">Add New Category</h5>
//                 <button type="button" className="close btn btn-blue" onClick={() => setShowModal(false)}>
//                   <span>&times;</span>
//                 </button>
//               </div>
//               <div className="modal-body">
...
//     axios.post('http://localhost:5000/api/stock_categories', newCategory)
//       .then((response) => {
//         fetchCategories(); // Re-fetch categories
//         setShowModal(false);
//         setNewCategory({ name: '', description: '' });  // Reset the form after successful submission
//         setLoadingCategory(false); // Set loading to false after submission
//       })
//       .catch((error) => {
//         console.error('Error adding category:', error);
...
//     if (isConfirmed) {
//       axios.delete(`http://localhost:5000/api/stock_categories/${id}`)
//         .then(() => {
