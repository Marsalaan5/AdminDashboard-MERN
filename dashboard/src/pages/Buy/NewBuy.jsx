...
//         setFormData((prev) => ({
//           ...prev,
//           stockQuantity: product.alert_quantity,
//           buyPrice: product.buy_price,
//           subtotal: (product.buy_price * (formData.purchaseQuantity || 0)).toFixed(2),
//         }));
//       } catch (error) {
...
//     <option key={product._id} value={product._id}>  {/* Updated from 'id' to '_id' */}
//       {product.stock_name}
//     </option>
//   ))}
// </select>
